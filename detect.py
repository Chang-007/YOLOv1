...
class YOLODetector:
    def __init__(self,
                 model_path, class_name_list=None, mean_rgb=None,
    ...
    def detect(self, image_bgr, image_size=448):
        ...
        for b in range(boxes_normalized.size(0)):
            ...
            x1, x2 = w * box_normalized[0], w * box_normalized[2]  # normalize x with image width.
            y1, y2 = h * box_normalized[1], h * box_normalized[3]  # normalize y with image height.
